...
export const privacyPolicyData = {
  en: {
    ...
    intro: [
      {
        id: "intro-1",
        content: `This Privacy Policy explains how [Company name] ("we", "us", "our") collects and uses personal data when you use the Visitor Menu of our café automation system (the "Service").`,
      },
      {
        id: "intro-2",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          {
            id: "s1-p2",
            content: `If we use a technology platform provider to host and operate the Service, that provider acts as our data processor, processing personal data only on our instructions.`,
          },
          {
            id: "s1-p3",
            content: `If required by law, we may also appoint an EU/EEA representative and/or a Data Protection Officer; their details will be published here.`,
          },
        ],
      },
      {
        ...
        paragraphs: [
          {
            id: "s2-p1",
            content: `This Policy applies only to the visitor menu section of our café automation application – the part you use to:

• Register and log in
• View menu items
• Place orders and send them to a waiter
• Create a caricature from your photo
• View your order history and communication history with venues`,
          },
          {
            id: "s2-p2",
            content: `Other parts of our systems (for staff, suppliers, etc.) may be covered by separate privacy documentation.`,
          },
        ],
      },
      {
...
• Authentication data (password hash, authentication tokens, login timestamps)`,
          },
          {
            id: "s3-p2",
            content: `3.2 Geolocation data

• Device location data (GPS, Wi‑Fi, Bluetooth or similar), if you grant us access
...
• Items ordered, time and place of order
• Table number (where applicable)
• Order status and payment-related metadata (we do not necessarily store full payment card details – this depends on the payment provider integrated; see their own privacy policy)`,
          },
          {
            id: "s3-p4",
...
• Technical data necessary to create and store the caricature (e.g. internal identifiers)`,
          },
          {
            id: "s3-p5",
            content: `3.5 Device and technical data

• Device type, operating system, screen size and orientation
• Browser or app version, language settings
• IP address and other identifiers (e.g. device or installation ID)
• Logs of app events (e.g. opening pages, clicking buttons) used to improve performance and reliability`,
          },
          {
            id: "s3-p6",
            content: `3.6 Usage history and communication data

• History of your orders in our cafés
• History of your interactions with different venues using our platform
• Feedback you provide, messages sent to the venue via the Service, support requests`,
          },
          {
            id: "s3-p7",
            content: `3.7 Analytics data

Analytics data collected via third‑party providers (Google and Meta/Facebook), such as:
• Aggregated usage statistics
• Pseudonymous identifiers used for analytics (not for advertising)
...
• Your consents and choices (e.g. location access, analytics consent)
• Records of your requests regarding your data (access, deletion, etc.)`,
          },
        ],
      },
      {
