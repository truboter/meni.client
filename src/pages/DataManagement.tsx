...
export function DataManagement({ language, onClose }: DataManagementProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* Header */}
      <div className="shrink-0 flex items-start justify-between gap-4 p-6 border-b border-gray-200 bg-white">
